...
1.  Fork the GitHub repository: https://github.com/aws-quickstart/quickstart-microsoft-dotnetcore-cicd
2.  The repository consists of:

* The quickstart-dotnetcore-cicd.yml AWS CloudFormation template
* BuildSpec.yml, used in CodeBuild
* Application source code

3. Obtain the needed inputs to use later in the installation:
...
* Type “.NET Core CI/CD” in the Note field.
* Check the repo box.

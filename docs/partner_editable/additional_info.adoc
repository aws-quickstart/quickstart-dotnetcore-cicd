...
[start=2]
. Navigate to the *Outputs* tab for the Elastic Beanstalk CloudFormation stack, as shown in <<load-balancer-url>>. Choose the load-balancer URL, and verify that the web page loads.
